...
import {
  ...
  createPlottedDataFileName,
  createSelectedDataFileName,
...
describe("export filenames", () => {
  it("uses YYMMDD_plotN naming", () => {
    ...
    expect(createSelectedDataFileName(3, date)).toBe("260707_plot3_data.xlsx");
  });
  ...
  it("can include a sanitized analysis name before the plot number", () => {
    ...
    expect(createSelectedDataFileName(3, date, "Run A")).toBe("260709_Run_A_plot3_data.xlsx");
