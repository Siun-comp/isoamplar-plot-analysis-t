...
| AC-PCR-037 | FR-006, FR-017, D026, D051 | Analysis XLSX contains no native editable Excel chart, and export/import performs no smoothing, normalization, baseline correction, automatic/import-time threshold calculation, Ct/Cq/Tt/Tp naming, or positive/negative interpretation. Approved user-set raw Threshold configuration is persisted without persisting derived result caches. | Unit + package/workbook inspection |
...
| AC-QP-005 | FR-003, IO-003 | The first usable specimen header blocks preview when blank; truly blank later specimen headers inherit within the paste source with information evidence. Missing reagent headers, unresolved non-shorthand specimen headers, empty fluorescence cells, nonnumeric fluorescence cells, duplicate curve labels, and similar specimen/reagent labels produce diagnostics consistent with the Excel parser policy. | Unit |
...
## Current Automated Coverage - 2026-07-14
